...
class CommentsSectionTest extends TestCase
{
     ...
     *@test
     */
    public function post_page_contains_comments_form_livewire_component()
    {
     ...
     *@test
     */
    public function valid_comments_can_be_posted()
    {
     ...
     *@test
     */
    public function comment_requireds_min_characters()
    {
